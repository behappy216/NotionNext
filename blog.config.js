...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '禅修, 博客', // 网站关键词 英文逗号隔开
...
<<<<<<< HEAD
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Notion blog', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'Notion blog', // 站点描述，被notion中的页面描述覆盖
...
>>>>>>> parent of be08d0b0 (Update blog.config.js)
